...
citation(year) = @match my_year(year) begin
...
citation_Temperature(year) = @match my_year(year) begin
...
citation_Salinity(year) = @match my_year(year) begin
...
citation_Oxygen(year) = @match my_year(year) begin
...
citation_Nutrients(year) = @match my_year(year) begin
