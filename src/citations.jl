...
citation(year) = @match product_year(year) begin
    ...
    _ => "I could not find a citation for WOD$(product_year(year)). Add it if you know where to find it!"
end

citation_Temperature(year) = @match product_year(year) begin
    ...
    _ => error("No citation for WOA$(product_year(year)) Temperature. Add it if it should be there!")
end

citation_Salinity(year) = @match product_year(year) begin
    ...
    _ => error("No citation for WOA$(product_year(year)) Salinity. Add it if it should be there!")
end

citation_Oxygen(year) = @match product_year(year) begin
    ...
    _ => error("No citation for WOA$(product_year(year)) AOU. Add it if it should be there!")
end

citation_Nutrients(year) = @match product_year(year) begin
    ...
    _ => error("No citation for WOA$(product_year(year)) Nutrients. Add it if it should be there!")
end
